...
> | **Thu Sep 24** | 🧵 | ⚠️ **HEAVY DAY — Wednesday's sewing moved here:** +2 whimsys (only 2 exist and the posts promise them) · 6 Vanilla Lace scrunchies · 2 lavender + 1 cinnamon sachet. **If it runs short, whimsys and sachets beat scrunchies** — 26 scrunchies are already in stock · ✅ **CASSIDY'S KINDLE SLEEVE — FINISHED (owner, 2026-09-24), 9″ × 7″ in Afternoon Tea, ties, 6 photos.** Cut generous, so case-or-bare no longer matters. **LOCAL DROP-OFF, so nothing to post** — waiting only on a fixed day; offer Mon 28 or Tue 29, in her hands by Wed Sep 30 for the Oct 3 birthday · 🧾 **MAURYA: TEA COVER + TEA MAT — ✅ PAID 2026-09-24, invoice `VBQJFYMO-0002`.** **$70.00 + $5.78 tax = $75.78**, Stripe fee **$2.50**, **net $73.28**, paid via Link. Billing address is San Antonio 78232, so **8.25% is correct**, and it lands in **Q3 — the return due Oct 20**. 📒 **Workbook row: Sep 24 · Maurya Buchanan · $70.00 · $5.78 tax · $2.50 fee · $73.28 net.** ✅ **The clock has started on the tea mat.** ⚠️ **The mat was invoiced at $35, and the published custom home-pieces floor is $40** — a made-to-order piece at $35 ties the $35 ready-made cover instead of clearing it, which is the same fault that moved the scrunchie floor to $8. Fine as a pair and already done; **price the next matching piece at $40 or sell it as a named set.** 🗓️ **Retire the cover to Stories around Oct 1**, now it is genuinely sold · 🧾 *(originally: invoiced $70)* and ✅ **her two finished bags were handed over the same day**, closing the Aug 18 job. ⛔ **The Suriel Tea Cover is now `soldOut: true`** in shop-data — it is one of a kind and was still buyable at $35 while the invoice sat unpaid. Product pages, sitemap (38 URLs), the Pinterest feed (1 out of stock) and the **Tea Covers JSON-LD block in index.html** (InStock → OutOfStock, which nothing regenerates) all updated. **Retire it to Stories in about a week**, per the one-of-a-kind rule — not tonight. ⚠️ **If the $70 goes unpaid, flip `soldOut` back.** ⚠️ **Nothing is cut for the tea mat until it is paid.** 🎁 **Blush and Whiskers tote** for her daughter: awaiting size, pocket, and needed-by. **Christmas pieces must be agreed and paid by about the first week of November** — the machine goes in a box before the Nov 25 move · ✅ **11 SCRUNCHIES SEWN (owner, 2026-09-24): 6 VANILLA + 5 LACE** — nearly double the 6 planned, so scrunchies are now roughly **37 in stock**, comfortably the deepest category. ⚠️ **The gap is now WHIMSYS: still only 2, and the market posts promise them.** If any sewing time is left tonight, whimsys beat everything else; sachets second. **Do not sew more scrunchies before Saturday** · 🎬 **ROSE LATTE CLOUD TIKTOK SHOT LIST WRITTEN (2026-09-24)** — `tools/print-kit/shot-lists/tiktok-rose-latte-cloud.html`, printed to Downloads. Five shots, ~35s, three hooks, caption and tags ready to copy. **The shot that carries it is sewing ONE pillow live on camera** — the bag cannot be reshot, but two squares and a handful of stuffing prove the 32. ⚠️ **Not this week** — markets Sat and Sun; film the table build instead, which costs nothing. **`shot-lists/` is a NEW folder beside `make-sheets/`**, same render workflow, for the next piece that deserves a video · 🧿 **STICKERS — ✅ ARRIVED 2026-09-24, IN TIME FOR SEP 26. TWO DESIGNS, TWO DIFFERENT JOBS. 75 stickers for $43 = 57¢ each.**
      ✅ **‘CREATING WHIMSY’ IS THE ONE TO SELL, at $3.** A dragon at a cauldron with books, thread and a cottage, and **it carries no shop name anywhere** — so a stranger buys it as art about themselves, not as an advert for a shop they just met. Tax-inclusive that nets $2.77; **break-even is 16 stickers.**
      ✅ **A THIRD DESIGN ARRIVED TOO, ALSO BRANDED** (owner, 2026-09-24), so it is **one sellable design against two giveaways.** Give one branded sticker with **every purchase, no minimum, and let the buyer pick which** — a threshold is one more thing to check at a busy table, and these are local advertising in a city she leaves on Nov 25, so they are worth more given away now than carried to Virginia. When they run out, they run out.
      ✅ **THE AUTUMN ONE IS THE GIVEAWAY — never sold.** Same dragon with coffee, pumpkins and the wordmark. It asks the buyer to advertise the shop, so it is handed over free with a purchase and tucked into online orders. Its seasonal art is right for exactly the Sep–Nov window that is left. ✅ **It spells the name "and", correctly** — unlike the printed card art.
      ⚠️ **BOTH READ AS AI-GENERATED ART, and some juried markets ban AI merchandise.** ⛔ **Do not put them out at the Pearl** (juried, "only approved products may be sold", and stickers were not on the application) **or at Mercado de Otono** unless checked first. The boutique and the night markets vet nobody. ⛔ **Do not list them on the website**, same rule as [[mascot-willow]].
      ⛔ **Do not order more before the January rebrand** — sell through these 75; new stock now is old stock in three months.
      ✅ **THE $1 STICKER PAYMENT LINK IS RETIRED — DEACTIVATED IN STRIPE 2026-09-24** (`plink_1UGn0HGhlm0fD4l8KZGB5Ilz`). Anyone opening the old URL now sees: *“This sticker link has been retired. Stickers are $3 at the table — please pay by tap or cash.”* **Stickers ring on Tap to Pay as a custom amount.** `tools/print-kit/build-sticker-qr.js` now REFUSES TO RUN, so no one can print a QR pointing at a dead link; the header says how to revive it if a new link is ever made. **Nothing else in the kit embedded that QR**, so no printed sign needs redoing. · 🏷️ **OFFERS REWRITTEN (owner, 2026-09-24) — a deal has to actually save money.** ⛔ **Whimsy "2 for $10" is GONE everywhere** ($5 each, so it was arithmetic dressed as an offer) · ✅ **Bows $12 or 2 for $20** · ✅ **Scrunchies $6 or 3 for $15** (the old "2 for $10" was the SAME rate as 3 for $15, so it went too) · Sachets keep **2 for $10**, which does save $2 · ⛔ **The "any 2 of the $5 or $6 pieces for $10" mix-and-match pill is REMOVED** from the price list, the gifts card and the flyer builder — it was the whimsy deal by another name. ⚠️ **The Sep 26 flyer already POSTED to Facebook still carries it** — honour it if anyone asks on the day. ⚠️ **The Scan-to-Pay quick links are fixed single prices**, so a 2-for-$20 bow pair or 3-for-$15 scrunchies must be rung on Tap to Pay as a custom amount · 🧵 **ROSE LATTE CLOUD CORRECTED: cream lining, NO pockets** (owner, 2026-09-24) — shop-data, the product page, the Pinterest feed and the story card all said brown plaid with a blush pocket. The make sheet keeps the pocket as an OPTIONAL step, since it is the pattern for the next one · 🗂️ **MARKET KIT FOLDER in Downloads** (`Dragon Ink market kit`) — cardstock and plain-paper subfolders plus a READ ME; every loose older copy in Downloads is stale · 📋 **TABLE PLAN UPDATED AND NOW DATED:** it carries `STOCK_AS_OF` in the header, the Kindle case has moved to the back row as a not-for-sale SAMPLE, the mug rug is in the browse row, and the Sunday +1h30 offset is on the sheet. ⚠️ **Standing rule (CLAUDE.md): edit `BANDS` AND `STEPS` and bump `STOCK_AS_OF` whenever a product is added or withdrawn** · 🏫 **NEW MARKET ENQUIRY, REPLIED 2026-09-25 — a Fri Nov 13 school popup, 3:30–7:30pm, $30, outdoor, no power, ~30 vendors.** Name and address are in `market-details-private.md`. ✅ Organiser verified real. 🎯 **The angle is CHRISTMAS TEACHER GIFTS** — **make ~20 gift card holders** before it; there are 3. ⛔ **Blocker: gymnastics 4:10 that day** — the reply says so and asks to confirm by the end of the following week. ⚠️ **It is the day before the LAST market (Nov 14)**, so treat it as clearing stock, not showcasing. ⚠️ Battery lights become mandatory · ✅ **5 MORE HAIR WHIMSYS SEWN (owner, 2026-09-25) — 7 in total**, which closes yesterday's gap; the posts promised them and there were only 2 · 🗳️ **SALES SHEET BUILT (2026-09-25):** `tools/print-kit/build-sales-sheet.js` — one page, tick a box per piece as it sells, then count up at the end. **Print 2, one per market**, plain paper, in the kit folder. **Built because Sep 19 could not be reconstructed:** Stripe held three card sales ($32, $10, $11) and the cash was $43, and **two of the three card amounts matched no list price**, so no arithmetic could get back to items. ⚠️ **The blank ROUNDED-PRICE lines are the whole point** — she rounds at the table, and a sheet that only allows list prices produces a tally that will not reconcile. It also carries the float/cash/card/tax box and a “how did you hear about me” tally · 📝 **CUSTOM ORDER PAPERWORK BUILT (2026-09-24):** `tools/print-kit/build-order-forms.js` makes a full **order form** (one per letter sheet) and a sheet of four **lead slips**. **Print on PLAIN WHITE paper, not the parchment** — they are written on, not looked at. Take **3 order forms and 8 slips** to each market. ⚠️ **The form is the EIGHTH place the custom price bands live** (CLAUDE.md updated) and the only one a customer signs and keeps — a stale band there cannot be quietly fixed later · ✅ **FIRST MUG RUG MADE (owner, 2026-09-24) — coffee print, diagonal cross-hatch quilting, finished 10″ × 7½″** (photos IMG_8168–8170). ⚠️ **The make sheet was written at 6″ × 9″ and has been REWRITTEN to her real size**, cut list and all — the sheet follows what she actually makes, not the other way round. **Still $12, or two for $20**; the bigger size makes that easier to defend at the table, not harder · **Rose Latte Cloud:** ✅ being tidied up 2026-09-22, ready for Saturday (owner) · 🪡 **Evening: Linda seam ripping, 30–45 min** |
...
> | **🌙 Sun Sep 27** | **MARKET 3 · 5–10pm · set-up 4pm · $25 PAID** | ✅ **BOOKED 2026-09-22** — the organiser of Oct 10 / Oct 30 cut the fee to **$25**, paid the same day. **ELECTRICITY IS AVAILABLE and the site is very well lit** (her words: vendors have not needed extra lighting) — still take the power bank for Tap to Pay. **Same site as the Oct 30 night market**, so it doubles as a scouting trip: parking, table positions, the crowd. ⛔ **Two markets back to back** — Sat 2:30–9, then Sun 4–10. Restock Sunday afternoon: **+2 whimsys, +2 sachets**. Own table; canopy loaned, LOADED IN THE CAR and light enough to put up single-handed (owner, 2026-09-22) — nothing to hire, and no second pair of hands needed. Name and place in private notes · 💵 **Vendor fees now $276.87 across seven markets** |
>
...
- [ ] 🆕 ✉️ **CUSTOM ORDER — A KINDLE SLEEVE FOR CASSIDY E. Came through the contact form 2026-09-15.**
      ...
      **Her words:** she would love a sleeve for her **Kindle Signature**, and asked for *"either the sleeve or the
      ...
      ✉️ **NUDGE SENT 2026-09-22** (drafted 2026-09-21) — carries the payment
...
- [x] ✅✅ **CLOSED — Maurya Buchanan — Wheelchair Quilted Tote + Custom Tote**, both in *Nesta's Cats*.
      🎉 **HANDED OVER 2026-09-24 (owner).** Finished 2026-08-18, delivered 37 days and eight pickup dates later.
      📸 **ASK HER FOR A PHOTO AND A REVIEW NOW, while she has them in her hands.** She has never been asked, and
      the wheelchair tote is the single most distinctive thing the shop has made — there is nothing like it in Kind
      Words or Stories. **Real reviews only, added by hand, verbatim.**
      🧵 **AND SHE HAS ORDERED AGAIN THE SAME DAY:** tea cover + tea mat invoiced **$70**, and a **Blush and
      Whiskers tote** for her daughter being specced. **That is the third repeat customer to convert off a first
      purchase** — after Brea P. and Linda — which is the pattern the marketing copy still does not use.
...
- [ ] 🆕 🎪 **A THIRD MARKET: SAT SEP 26 — added by the owner 2026-09-14. It is now the FIRST one.**
  ...
  **Fees now: $20 + $30 + $30 = $80 for all three.** The $20 is covered by two bows.
  ...
  (Expenses → Marketing), entered by hand 2026-09-21 — none of them ever touch Stripe.
...
- [x] 🚫 🎪 **AN OCT 3 OUTDOOR TRADE DAY — DECLINED. The owner is not replying (2026-09-17).** No answer
  ...
  10×10 with weights is **$80–150**, four to seven times the booth fee, so it only pays back if it's
...
- [ ] 🎪 **MARKETS 2 AND 3 — SAT OCT 10 (DAY) and FRI OCT 30 (NIGHT).**
  ...
  **Stock plan:** everything already in the shop (~50 pieces) goes, plus ~25 new:
  ...
  | 🌲 **Balsam fir sachets** (owner, 2026-09-20) — dried balsam needles, bought by the bag; Christmas prints or red plaid | 10–12 | **NEW, $8** — the strongest of the scented ideas for **Oct 30, Nov 14 and any December market**: the smell is tied to Christmas memory and people rebuy it yearly. Sew a **ribbon hanging loop** so it works on a wardrobe rail or a car mirror. Sits above the $6 lavender because the filling costs more. Make them in **October**, so they are in stock before the holiday markets |
  | 🎁 **Fabric wrap squares** (owner, 2026-09-20) — hemmed cotton squares, reusable gift wrapping, from scraps and Christmas prints | 8–10 | **NEW, $8 small (18in) · $14 large (24in)**, both in Stripe (`prod_VIU5yScV9OFc5k` · `prod_VIU5EOk59jxFdG`). **Chosen over drawstring bags**: four straight hems, no casing or cord, packs flat for markets, and "plastic-free wrapping you keep" sells itself in November. Pinking shears are faster than hemming but look cheaper on a keepsake. 📌 **Upsell to try: a wrap square with a sachet knotted into it, $15** — the wrapping is the second present |
...
- [ ] 🎀 **PATTERN THREE — THE SAILOR BOW — LIVE 2026-09-10, own tag `pattern-sailor-bow`, own
  ...
  ✅ **The last four open numbers were answered by the owner 2026-09-11** and are in the PDF:
  finished size **6″ × 6″** (the export said 8½″ long) · piece A **12″ × 6″ is right**, its ends
  **butted edge to edge and zigzagged, not overlapped** (so the loop is 6″ wide) · the tails'
  diagonal is **eyeballed**, so 1½″ is printed as a guide · about **30 minutes** to make.
...
that was right; a fourth free one would have taught the wrong lesson on the shop's biggest customer.
      ...
      **add more to it**, so the Sep 18 due date is **extended by agreement**. Everything below about the print arriving
      ...
      🚨 **TAKE THE PHOTO HOME FROM THE HANDOVER ON THE 17th.** No digital copy existed of the first picture, which is
      exactly what cost this job two weeks. Leaving without it buys a third trip.
      🎨 **LAYOUT DECIDED 2026-09-16 — flat things on the bulky side, standing things on the flat side.** The **new 4×6
      photo in a matching gold frame goes TOP LEFT**, on the leopard drape — stitch through the frame's corners into the
      board, because that mounded fold is the least stable surface in the box. The **figurine goes on the STAR PANEL,
      UPPER RIGHT**: it is the flattest area and the only one with the depth for a standing figure. The **existing photo
      (bottom left) and the red bicycle (middle right) do not move.** Stagger the new pair — do not line them into a grid.
      Match the frame **finish**, not just the size; brushed beside bright gold reads as a mistake at six inches.
      📏 **MEASURE THE FIGURINE against the internal depth BEFORE committing.** If it is close, tilt it back into a fold —
      that buys depth and stops it pitching forward. Mount it on a small fabric-covered block so the **weight is
      physically carried**, then museum wax under the base against tipping. **Wax alone on fabric will not hold ceramic
